...
def solve_ucs(start):
    ...
    start_cost = calculate_cost(start)
    start_node = create_node(start, None, None, 0, start_cost)
    ...
    while heap:
        ...
        if current_state == goal:
            ...
            print("Số bước:", current_node["step"])
        ...
        for rule in rules:
            ...
            if state_str not in visited:
                ...
                heapq.heappush(heap, (new_cost, counter, state_str, new_node))
